...
public class RandomUtils {
     ...
     * @throws IllegalArgumentException if {@code n <= 0L}
     */
     ...
     * @return a random real number from a Gaussian distribution with mean {@code mu}
    ...
    public static int poisson(Random random, double lambda) {
        if (!(lambda > 0.0)) {
            throw new IllegalArgumentException("mean lambda must be positive: " + lambda);
        }
        if (Double.isInfinite(lambda)) {
            throw new IllegalArgumentException("mean lambda must not be infinite: " + lambda);
        }
        // using algorithm given by Knuth
        int k = 0;
        double p = 1.0;
    ...
    public static double exponential(Random random, double lambda) {
        if (!(lambda > 0.0)) {
            throw new IllegalArgumentException("rate lambda must be positive: " + lambda);
        }
     ...
     * @param a the array to shuffle
     */
    public static void shuffle(double[] a, Random random) {
        if (a == null) {
            throw new IllegalArgumentException("argument array is null");
        }
        int n = a.length;
     ...
     * @param a the array to shuffle
     */
    public static void shuffle(char[] a, Random random) {
        if (a == null) {
            throw new IllegalArgumentException("argument array is null");
        }
        int n = a.length;
     ...
     * @param a the array to shuffle
     */
    public static void shuffle(long[] a, Random random) {
        if (a == null) {
            throw new IllegalArgumentException("argument array is null");
        }
        int n = a.length;
    ...
    public static double pareto(Random random, double alpha) {
        if (!(alpha > 0.0)) {
            throw new IllegalArgumentException("shape parameter alpha must be positive: " + alpha);
        }
     ...
     */
    public static int discrete(int[] frequencies, Random random) {
        if (frequencies == null) {
            throw new IllegalArgumentException("argument array is null");
        }
        ...
        // the for loop may not return a value when both r is (nearly) 1.0 and when the
        // cumulative sum is less than 1.0 (as a result of floating-point roundoff error)
        throw new RuntimeException("discrete distribution failure");
    }
}
